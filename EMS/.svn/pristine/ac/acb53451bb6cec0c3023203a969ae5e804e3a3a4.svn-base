...
<%
	String ccid=request.getAttribute("ccid")+"";
	String json=request.getAttribute("list")+"";
...
<body>
	...
	<form method="post" action="Jwgl.do?method=editschedule">
	<input type="hidden" name="ccid" value="<%=ccid%>"/>
		<div>
			<div>
				<%=info.get("classname") %>班&nbsp;&nbsp;新增 <%=info.get("coursename") %>
