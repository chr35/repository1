<%@page import="com.ems.entity.Student"%>
...
<body>
	<div id="catalog">信息维护->个人信息管理</div>
	...
	<div style="width:50%;min-width: 450px;display: inline-block">
			<table style="width:100%;">
				...
				<tr><td>入学时间</td><td><%=user.getRxsj() %></td></tr>
				<tr><td>户籍所在地</td><td><%=user.getHjszd() %></td></tr>
			</table>
	...
	<script type="text/javascript">
		function chgpass(){
			$.post("Student.do?method=chgpassword", {
				"oldpass" : $("#oldpass").val(),
				"newpass" : $("#newpass").val()
