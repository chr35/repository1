...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/ems.main.css?v=1.0.1">
<style type="text/css">
#zx:hover{
	...
	<div id="divone"
		...
		<ul class="navigation">
			...
			<li><a href="javascript:void(0)" target="thePage">课程管理</a>
				<ul>
					<li><a href="jsp/teacher/studentgrade.jsp" target="thePage">学生成绩管理</a></li>
				</ul>
				<div class="clear"></div>
			</li>
			<li><a href="javascript:void(0)" target="thePage">信息查询</a>
				<ul>
					<li><a href="Teacher.do?method=selschedule" target="thePage">课表查询</a></li>
					<li><a href="jsp/teacher/studentlist.jsp" target="thePage">学生表查询</a></li>
					<li><a href="jsp/teacher/teachergrade.jsp" target="thePage">教学评价查询</a></li>
				</ul>
				<div class="clear"></div>
			</li>
			<li><a href="javascript:void(0)" target="thePage">信息维护</a>
				<ul>
					<li><a href="jsp/teacher/userinfo.jsp" target="thePage">个人信息管理</a></li>
				</ul>
			</li>
		</ul>
	</div>
